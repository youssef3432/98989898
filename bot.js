...
var servers = ['351519476879196174','351519138566373386','353224340159987712','','','','','','','','','','','',''];
var queue = [];
var guilds = ['',''];
var queueNames = [];
var isPlaying = false;
				...
				fetchVideoInfo(id, function(err, videoInfo) {
					...
					let play_info = new Discord.RichEmbed()
						...
						.addField('||** Playing **', `**${videoInfo.title}
							  **`)
						.setColor("RANDOM")
                        .addField(`By : ${message.author.username}`, `**YOUSSEF**`)
						.setThumbnail(videoInfo.thumbnailUrl)
							
					// .setDescription('?')
					message.channel.sendEmbed(play_info)
					// client.user.setGame(videoInfo.title,'https://www.twitch.tv/YOUSSEF98123');
				});
			});
		}
	}
