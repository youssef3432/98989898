...
client.on("message", message => {
 if (message.content === "-help") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('تصميم Harmond')
      .setFooter('اوامر الادمنيه')
	  .addField('-bc', `لخاصية البرودكستات`)
	  .addField('-ctc', `انشاء روم كتابي `)
	  .addField('-cvc', `انشاء روم صوتي مع كتابة اسم الروم `)
	  .addField('-restart', `اعادة تشغيل البوت داخل سيرفرك فقط .`)
      .setFooter('======================================================')
      .setFooter('اوامر الاعضاء')
      .addField('-invite', `لاضافة البوت الى سيرفرك`)
	  .addField('-roles', `لمعرفة الرتب الي في السيرفر`)
	  .addField('-bot', `لمعرفة البوت في كم سيرفر`)
      .addField('-avatar', `يجبلك الافتار حقك يعني صورة حسابك`)
	  .addField('-وقت', `لمعرفة الوقت`)
...
client.on("message", message => {
 if (message.content === "-invite") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('')
      .addField('شكرا لك لاستخدامك البوت يوسف', `https://discordapp.com/api/oauth2/authorize?client_id=404392083189923841&permissions=0&scope=bot`)
  message.author.send({embed});
...
client.on("message", message => {
 if (message.content === "-support") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© Gold Bot')  
      .addField('سيرفر الدعم الفني', `  https://discord.gg/zdAaXj9`)
  message.author.send({embed});
...
client.on('message', msg => {
  if (msg.content === '-restart') {
    msg.channel.sendMessage(' <bc1 احترافي ومفصل ');
    msg.channel.sendMessage(' مختصر جدا بشكل كبير <bc2 ');
   message.channel.sendEmbed(embed);
...
if (message.content.startsWith('-Hashem')){
...
.addField('تاريخ دخولك للديسكورد',message.author.createdAt,  true)
.addField('تاريخ دخولك للسيرفر',message.member.joinedAt, true)
.setFooter(z.username,message.author.avatarURL)
message.channel.sendEmbed(embed);
}
});
...
client.on("message", (message) => {
if (message.content.startsWith("-ctc")) {
            if (!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply("You Don't Have `MANAGE_CHANNELS` Premissions ");
        let args = message.content.split(" ").slice(1);
