...
const Za7f = [
 ...
 .addField('GAMES' ,
  ...
  console.log('[7] Send By: ' + message.author.username)
    }
});
...
client.on('message', function(message) {
    ...
    if(message.content.startsWith('قرعه')) {
...
client.login('NDM4NjM5ODQ3ODcyMTM1MTY4.Dcc3CQ.dyliq0E5SDam-bbS9eqyjWTOUos');
